//Добавьте null-объекты в RegisteredFactories.java

//Регистрация фабрик класса в базовом классе
package typeInformations.question24;

import typeInformations.Null;
...
class NullFilter extends Filter implements Null{
    private NullFilter(){super();}
    private static Filter NULL=new NullFilter();
    public static class Factory implements typeInformations.factory.Factory<NullFilter>{
        public NullFilter create(){ return (NullFilter)NULL;}
    }
