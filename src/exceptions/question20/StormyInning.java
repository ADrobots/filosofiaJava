/*Измените программу StormyInning, добавив туда исключения типа
UmpireWxception и методы, возбуждающие это исключение. Протестируйте получившуюся
иерархию
 */

package exceptions.question20;
...
abstract class Inning{
    ...
    public void methodInInning() throws UmpireException{};
...
public class StormyInning extends Inning implements Storm {
    ...
    StormyInning() throws RainedOut, BaseballException, UmpireException{}
    StormyInning(String s) throws Foul, BaseballException, UmpireException {}
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("EmpireException");
        }catch(BaseballException e){
            System.out.println("BasebalException");
        }catch (StormException e){
            System.out.println("RainedException");
        }

        try{
            Inning in2=new StormyInning();
            in2.methodInInning();
        }catch (UmpireException e){
            System.out.println("EmpireException");
        }catch(BaseballException e){
