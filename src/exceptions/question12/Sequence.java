/**
 * Измените пример так, чтобы при попытке размещения слишком большого
 * колличетсва элементов программа выдввала соответствующее
 * исключение.
 */

package exceptions.question12;
...
public class Sequence {
    ...
    /*void add(Object object){
        if(next<items.length){items[next++]=object;}else {throw new RuntimeException();}
    } */                                                      // если 0<4 items[1]=0
                                                            // если 1<4 items[2]=1
                                                            // если 2<4 items[3]=2
                                                            // если 3<4 items[4]=3
    ...
    //вариант из книги
    void add(Object object) throws ArrayIndexOutOfBoundsException{
        if (next==items.length)throw new ArrayIndexOutOfBoundsException("Элементов больше положенного");
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i<4; i++){sequence.add(i); } //0
                                                    //1
                                                    //2
                                                    //3
                ...
                selector.next();                                    //if(0<4) i=0+1
                                                            ...
                                                            //if(3==4) false
                                                                //print items[3]{ znach 3 )
                                                                    //if(3<4) i=3+1
                                                            //if(4==4) true
        sequence.add(Integer.toString(12));
    }
}
